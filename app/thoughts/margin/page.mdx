...
## The problems with using margins in component-based systems
...
#### 2. Margin makes reusability harder
...
Designers think about space in relation and context: they define how far a component should be from another component in a specific layout and context—not globally.
