...
TailwindCSS popularized [space between](https://tailwindcss.com/docs/space) and, for flexbox and grid, [gap](https://tailwindcss.com/docs/gap) utility classnames:
...
1. Spacers bring us closer to how designers think
2. Spacers make our designs more consistent by aligning all spacing to a grid
3. Spacers force us to build more reusable and encapsulated components
