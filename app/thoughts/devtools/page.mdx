...
### Dev tools can't just be good, they have to be _great_

These two implications combined mean that in order to build a business in dev tools, it's not enough to build something good. You have to build something _great_.
...
### Everything changes all the time for developers

On top of that, we are an ecosystem of inventors that can share new ideas with everybody else in a second. Thus unsurprisingly, new frameworks, libraries, and packages are invented that change the way we work (usually for the better!) all the time.
...
So, it's not enough to be great. You have to be great, and then keep being great for a loooong time.

And that's really hard.

---

Let me share a few examples of companies that are doing great from [my own angel investing portfolio](/investments) (which is dev tools-heavy given my background and expertise).
