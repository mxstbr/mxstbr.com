...
- **K26 — As a kid, I can open an eligible current or untimed chore to complete it or request required approval.** There is no Skip action. All chore-title speech is removed.
...
- **K21/K30 — As a kid, I can track progress and earn the two-star period bonus by completing the required work.** Removing a chore from view when its window expires does not mark it done. Skips provide neither progress nor bonus eligibility because skipping is removed.
...
Each child earns **two additional stars for completing all tasks in a nonempty named time period**. This replaces the ten-star **daily** bonus; completing the whole day adds no further bonus. Untimed Bonus chores are outside the period target. Pending approvals can settle the original period reward later, once all required work is approved. Empty periods have neither a bonus offer nor a payout. A missed required occurrence must not silently disappear from bonus accounting merely because its card is no longer shown. On-time submissions still awaiting approval remain pending, not missed or completed; a later approval may settle the original day’s progress and bonus. Pauses and schedule edits remain distinct parent scheduling operations; they do not manufacture a completion or award chore stars.
...
| K57–K58                        | Reading an open or completed chore’s title aloud                                                                                                                               |
...
- **P47–P49 — As a parent, I can receive chore, approval, undo, period-bonus, and reward updates in Telegram.** Skip and dedicated bedtime notifications disappear. Notifications and mutations share an authoritative result so retries do not create duplicate credit.
