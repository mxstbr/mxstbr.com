...
- [managing.md](managing.md) explains current agent operations. `/chores` uses `chores2` tools; `/chores2` is the separate legacy board.
...
pnpm exec prettier --write docs/chores2 scripts/render-chores-behaviors.mjs
```
